...
<style>
    ...
    #searchprod{
        ...
        text-align: center;
        border:none;
        border-bottom:2px solid #f2dab9;
    }
  ...
  <body class="u-body ">
  <header class="u-clearfix u-custom-color-4 u-header u-sticky u-header" id="sec-6cd2"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
          ...
          <a class="u-btn u-button-link u-button-style u-custom-font u-font-arial u-none u-text-body-alt-color u-btn-1" href="../Accueil.html" data-page-id="18964500">Déco-Pierre</a>
      </div></header>
      ...
      <div class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-container-style u-expanded-width u-group u-shape-rectangle u-group-1">
        <div class="u-container-layout u-container-layout-1">
          <h3 class="u-align-center u-text u-text-1"><b>
              <span class="u-text-palette-3-light-2">PROD</span></b>UITS
          </h3>
        </div>
      </div>
    </section>

    <section class="u-border-1 u-border-custom-color-5 u-clearfix u-valign-middle u-white u-section-3" id="sec-e67e">
        <ul class="nav" >
            @foreach($cats as $cat)
  ...
  <br>
      <input type="text" placeholder="Recherche"style="margin:0px auto; display:block;" id="searchprod" />
<br>
  <br>
  <section class="u-clearfix u-lightbox u-section-5" id="sec-b4b9">
                ...
                @foreach($prods as $prod)
                    <div class="u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-1">
                            <img alt="" class="u-expanded-width u-image u-image-round u-radius-2 u-image-1" data-href="{{'/description/'.$prod->id}}" data-image-width="640" data-image-height="1388"  src="{{ asset('images/'. $prod->images[0]->image_name) }}">
                            <h6 class="u-align-center u-custom-font u-font-arial u-text u-text-1">{{ $prod->nom }}</h6>
                            <p class="u-align-center u-custom-font u-font-open-sans u-text u-text-2"> {{$prod->description}}.</p>
                            <a href="{{ url('add-to-cart/'.$prod->id) }}"
                               class="u-active-none u-btn u-button-style u-hover-none u-none u-text-hover-palette-2-base u-text-palette-1-base u-btn-1">
                                <span class="u-icon u-text-palette-2-base"><svg class="u-svg-content" viewBox="0 0 511.334 511.334" style="width: 1em; height: 1em;">
                                        <path d="m506.887 114.74c-3.979-5.097-10.086-8.076-16.553-8.076h-399.808l-5.943-66.207c-.972-10.827-10.046-19.123-20.916-19.123h-42.667c-11.598 0-21 9.402-21 21s9.402 21 21 21h23.468l23.018 256.439c.005.302-.01.599.007.903.047.806.152 1.594.286 2.37l.842 9.376c.016.177.034.354.055.529 2.552 22.11 13.851 41.267 30.19 54.21-8.466 10.812-13.532 24.407-13.532 39.172 0 35.106 28.561 63.667 63.666 63.667 35.106 0 63.667-28.561 63.667-63.667 0-7.605-1.345-14.9-3.801-21.667h114.936c-2.457 6.767-3.801 14.062-3.801 21.667 0 35.106 28.561 63.667 63.667 63.667s63.667-28.561 63.667-63.667-28.561-63.667-63.667-63.667h-234.526c-15.952 0-29.853-9.624-35.853-23.646l335.608-19.724c9.162-.538 16.914-6.966 19.141-15.87l42.67-170.67c1.567-6.272.158-12.918-3.821-18.016z"></path>
                                    </svg><img></span>&nbsp;Ajouter au panier
                                <input type="hidden" id="hiddencat" value="{{ $prod->categorie }}" >
                            </a>
                        </div>
                    </div>
                @endforeach
  ...
  <script>
      ...
      function Filtre(){
          ...
          var exits = false;
          $(".u-repeater-item").each(function (index) {
              var title =  $(this).find(".u-text-1").html().toString();
              var cat = '' ;
              if ($(".selectedcat").html()==null){
                  cat = $(this).find('input').val().toString();
              }else {
                  cat = $(".selectedcat").html().toString();
              }
              if($(this).find('input').val().toString()===cat) {
                  if ((title.toLowerCase().includes($('#searchprod').val().toLowerCase()))) {
                      if (i >= (nump * (num - 1)) && i < (nump * num)) {
                          exits = true ;
                          $(this).show();
                      } else {
                          $(this).hide();
      ...
      $(".nav").on("click",".linkpag",function (e){
          e.preventDefault();
