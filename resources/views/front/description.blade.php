...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Déco-Pierre</title>
      ...
      <link rel="stylesheet" href="{{ asset('css/Description.css') }} " media="screen">
  ...
  <body class="u-body u-overlap u-overlap-contrast"><header class="u-clearfix u-custom-color-4 u-header u-sticky u-header" id="sec-6cd2"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="sec-3876">
            ...
            <div class="u-layout-col">
              <div class="u-size-30">
                <div class="u-layout-row">
                    @if(isset($prod->images[0]->image_name))

                    <div class="u-align-left u-container-style u-layout-cell u-size-30 u-layout-cell-1">
                    <div class="u-container-layout u-valign-bottom-sm u-valign-bottom-xs u-container-layout-1" src="">
                      <img  src="{{ asset('images/'. $prod->images[0]->image_name) }}" class="u-expanded-width-sm u-expanded-width-xs u-image u-image-default u-image-1" src="images/178349514_4233530540004565_7299969444151605646_n.jpg" alt="" data-image-width="720" data-image-height="960">
                    </div>
                  </div>
                    @endif
                        @if(isset($prod->images[1]->image_name))

                    <div class="u-align-left u-container-style u-layout-cell u-size-30 u-layout-cell-2">
                    <div class="u-container-layout u-container-layout-2" src="">
                      <img  src="{{ asset('images/'. $prod->images[1]->image_name) }}" class="u-expanded-width-sm u-expanded-width-xs u-image u-image-default u-image-2" src="images/17881a90e7c0b7303b8e6e40c68a8b921.jpg" alt="" data-image-width="1166" data-image-height="1600">
                    </div>
                  </div>
                        @endif
              ...
              <div class="u-size-30">
                <div class="u-layout-row">
                    @if(isset($prod->images[2]->image_name))
                  <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-3">
                    <div class="u-container-layout u-container-layout-3">
                      <img  src="{{ asset('images/'. $prod->images[2]->image_name) }}" class="u-expanded-width-lg u-expanded-width-md u-expanded-width-xl u-image u-image-default u-image-3" src="images/178349514_4233530540004565_7299969444151605646_n.jpg" alt="" data-image-width="638" data-image-height="487">
                    </div>
                  </div>
                    @endif
                  <div class="u-align-left u-container-style u-layout-cell u-size-30 u-white u-layout-cell-4">
                    <div class="u-container-layout u-valign-middle u-container-layout-4">
                      <h2 class="u-text u-text-1">{{$prod->nom}}</h2>
                      <p class="u-text u-text-2">{{$prod->description}}</p>
                      <a href="https://nicepage.com/c/product-list-website-templates" class="u-active-none u-align-left u-btn u-button-style u-hover-none u-none u-text-hover-palette-2-base u-text-palette-1-base u-btn-1"><span class="u-icon u-text-palette-2-base"><svg class="u-svg-content" viewBox="0 0 511.334 511.334" style="width: 1em; height: 1em;"><path d="m506.887 114.74c-3.979-5.097-10.086-8.076-16.553-8.076h-399.808l-5.943-66.207c-.972-10.827-10.046-19.123-20.916-19.123h-42.667c-11.598 0-21 9.402-21 21s9.402 21 21 21h23.468l23.018 256.439c.005.302-.01.599.007.903.047.806.152 1.594.286 2.37l.842 9.376c.016.177.034.354.055.529 2.552 22.11 13.851 41.267 30.19 54.21-8.466 10.812-13.532 24.407-13.532 39.172 0 35.106 28.561 63.667 63.666 63.667 35.106 0 63.667-28.561 63.667-63.667 0-7.605-1.345-14.9-3.801-21.667h114.936c-2.457 6.767-3.801 14.062-3.801 21.667 0 35.106 28.561 63.667 63.667 63.667s63.667-28.561 63.667-63.667-28.561-63.667-63.667-63.667h-234.526c-15.952 0-29.853-9.624-35.853-23.646l335.608-19.724c9.162-.538 16.914-6.966 19.141-15.87l42.67-170.67c1.567-6.272.158-12.918-3.821-18.016z"></path></svg><img></span>&nbsp;Ajouter au panier
                      </a>
                    </div>
                  </div>
                </div>
