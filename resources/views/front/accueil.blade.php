...
<style>
  ...
  <body class="u-body u-overlap u-overlap-transparent"><header class="u-clearfix u-custom-color-4 u-header u-sticky u-header" id="sec-6cd2"><div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-3" id="carousel_548a">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-clearfix u-gutter-0 u-layout-wrap u-layout-wrap-1">
          <div class="u-layout">
            <div class="u-layout-row">
              <div class="u-align-left u-container-style u-image u-layout-cell u-size-29 u-image-1" data-image-width="640" data-image-height="1388">
    ...
    <section class="u-clearfix u-white u-section-4" id="sec-a9d9">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-align-center u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-container-style u-group u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <h3 class="u-align-center u-text u-text-1"><b>
                <span class="u-text-palette-3-light-2">GALERIE&nbsp;</span></b>(CATégories)
            </h3>
          </div>
        </div>
      </div>
        ...
        <div  class="u-align-center u-gallery u-layout-grid u-lightbox u-show-text-always u-gallery-1" style="margin: 0 auto;">
          <div class="u-gallery-inner u-gallery-inner-1" style="margin:0 auto;">
              ...
              <div class="u-back-slide u-back-slide-1" data-image-width="960" data-image-height="720">
                <img class="u-back-image u-expanded u-back-image-1" src="{{'images/'. $cat->image_name }}" alt="Margo">
              </div>
              <div class="u-over-slide u-shading u-valign-middle u-over-slide-1">
                <h3 class="u-gallery-heading">{{ $cat->nom }}</h3>
                <p class="u-gallery-text" style="font-size: 0.875rem;">Cliquez pour plus</p>
              </div>
            </div >
              @endforeach
          </div>
    ...
    <section class="u-clearfix u-valign-bottom u-white u-section-6" id="sec-e017">
      <div class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-container-style u-expanded-width u-group u-shape-rectangle u-group-1">
        <div class="u-container-layout u-container-layout-1">
          <h3 class="u-align-center u-text u-text-1"><b>
              <span class="u-text-palette-3-light-2">SHOW-</span></b>Rooms
          </h3>
        </div>
      </div>
    </section>
    <section class="u-carousel u-slide u-valign-middle u-block-1590-1" id="carousel_f5a0" data-interval="5000" data-u-ride="carousel">
      <ol class="u-absolute-hcenter u-carousel-indicators u-block-1590-2">
        <li data-u-target="#carousel_f5a0" class="u-active u-grey-30" data-u-slide-to="0"></li>
      </ol>
      <div class="u-carousel-inner" role="listbox">
          <?php $i=true; ?>
          @foreach($shows as $show)
                      <div id="{{$show->id}}" class="{{ $i? 'u-active u-align-center u-carousel-item u-clearfix u-section-7-1': 'u-align-center u-carousel-item u-clearfix u-section-7-1' }}">
                          <div class="u-clearfix u-sheet u-sheet-1">
                              <div class="u-align-center u-gallery u-layout-grid u-lightbox u-show-text-on-hover u-gallery-1">
                                  <div class="u-gallery-inner u-gallery-inner-1">
                                      <div class="u-effect-fade u-gallery-item u-gallery-item-1" data-image-width="2000" data-image-height="1333" data-href="https://goo.gl/maps/rkCvFMJH4vs1hybm6" data-page-id="23791874">
                                          <div class="u-back-slide u-back-slide-1" data-image-width="1729" data-image-height="1195">
                                              <img class="u-back-image u-expanded u-back-image-1"  src="{{ asset('images/'. $show->image_name) }}" alt="">
                                          </div>
                                          <div class="u-over-slide u-shading u-valign-middle u-over-slide-1">
                                              <h3 class="u-custom-font u-font-arial u-gallery-heading" style="background-image: none; font-weight: 400; font-size: 1.5rem;"></h3>
                                              <p class="u-custom-font u-font-arial u-gallery-text" style="margin-top: 20px; background-image: none;">Cliquez pour localisation</p>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              <p class="u-align-center u-custom-font u-font-arial u-text u-text-1"> {{$show->adresse}}</p>
                              <p class="u-align-center u-custom-font u-font-arial u-text u-text-palette-3-light-1 u-text-2">+216 29 403 488</p>
                          </div>
                      </div>
                  <?php $i = false ?>
          @endforeach
      </div>
      <a class="u-absolute-vcenter u-carousel-control u-carousel-control-prev u-text-grey-15 u-block-1590-5" href="#5" role="button" data-u-slide="prev">
      ...
      <a class="u-absolute-vcenter u-carousel-control u-carousel-control-next u-text-grey-15 u-block-1590-6" href="#6" role="button" data-u-slide="next">
        <span aria-hidden="true">
    ...
    <section class="u-clearfix u-white u-section-8" id="sec-d442">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-align-center u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-container-style u-group u-group-1">
          <div class="u-container-layout u-valign-middle u-container-layout-1">
            <h3 class="u-align-center u-text u-text-1"><b>
                <span class="u-text-palette-3-light-2">Contactez-</span></b>NOUS
            </h3>
          </div>
        </div>
      </div>
    </section>
    <section class="u-align-center u-clearfix u-section-9" id="sec-63dd">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-form u-form-1">

            <form action="/savemessage" method="GET" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px;">
            <div class="u-form-group u-form-name u-form-group-1">
              <label for="name-6797" class="u-form-control-hidden u-label">Name</label>
              <input type="text" placeholder="E-mail" id="name-6797" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required>
                <p style="color: red; display: none"></p>
            </div>
            <div class="u-form-email u-form-group u-form-group-2">
              <label for="email-6797" class="u-form-control-hidden u-label">Email</label>
              <input type="text" placeholder="Sujet" id="email-6797" name="sujet" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required>
                <p style="color: red; display: none"></p>

            </div>
            <div class="u-form-group u-form-message u-form-group-3">
              <label for="message-6797" class="u-form-control-hidden u-label">Address</label>
              <textarea placeholder="Message" rows="4" cols="50" id="message-6797" name="message" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required=""></textarea>
                <p style="color: red; display: none"></p>
            </div>
            <div class="u-align-left u-form-group u-form-submit u-form-group-4">
                <button type="submit"  class="u-border-none u-btn u-btn-submit u-button-style u-palette-3-light-2 u-btn-1"> Submit </button>
            </div>
          </form>
        </div>
      </div>
  ...
  <script>
      $(document).ready(function() {
          ...
          $(".u-active").on("click", ".u-effect-fade.u-gallery-item.u-gallery-item-1", function(){
          ...
          $('form').submit(function (e){
              ...
              if(!pattern.test(email.val())){
                  ...
                  error.html('votre E-mail n\' est pas valide');
              }else {
                  window.location.reload();
              }
          });

      $('.u-block-1590-6').click(function (e){
          e.preventDefault();
          var ele =   $('.u-active.u-align-center.u-carousel-item') ;
          if (ele.next().length) {
              ele.removeClass('u-active');
              ele.next().addClass('u-active');
          }
      });

      $('.u-block-1590-5').click(function (e){
          e.preventDefault();
          var ele =   $('.u-active.u-align-center.u-carousel-item') ;
          if (ele.prev().length) {
              ele.removeClass('u-active');
              ele.prev().addClass('u-active');
          }
      });
