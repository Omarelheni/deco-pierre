        ...
        <div class="templatemo-content-container">
            ...
            <div class="templatemo-content-container">
                <div class="templatemo-content-widget white-bg">
                    <h2 class="margin-bottom-10" align="center">Ajouter un Coupon du reduction</h2>
                    <form action="{{ route('coupons.store') }}" method="POST" >
                        @csrf
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                <label for="inputFirstName">Code</label>
                                <input type="text" class="form-control" id="inputFirstName" placeholder="code" name="code">
                                @error('code')
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                ...
                                <div class="form-control">
                                    <input type="range" min="1" max="100" value="20" class="slider" id="myRange" name="pourcentage">
                                </div>
