        ...
        <div class="templatemo-content-container">
                ...
                <div class="panel panel-default table-responsive">
                    ...
                    <table class="table table-striped table-bordered templatemo-user-table table-list-search">                          <thead>
                        <tr>
                            ...
                            <td class="th"><a href="#" class="white-text templatemo-sort-by">Google Map <i class="fa fa-caret-down"></i></a></td>
                            <td>Edit</td>
                            <td>Delete</td>
                        </tr>
                        </thead>
                        @foreach($shows as $show)
                            <tr>
                                <td><img src="{{ asset('images/'.$show->image_name)}}" style="height: 100px;width: 100px;border-radius: 50px;"></td>
                                <td>{{ $show->adresse }}</td>
                                <td><a href="{{ $show->adresse_map }}">Localisation</a></td>

                                <td><a href="{{route('showrooms.edit',$show->id)}}" class="btn btn-info">Edit</a></td>
                                <td>
                                    <form action="{{ route('showrooms.destroy', $show->id)}}" method="post">
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="templatemo-content-container">
                <div class="templatemo-content-widget white-bg">
                    <h2 class="margin-bottom-10" align="center">Modifier une showroom</h2>
                    <form action="{{ route('showrooms.update',$showroom) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" id="inputFirstName" placeholder="Adresse" value="{{ $showroom->adresse }}" name="adresse">
                                @error('adresse')
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                <label for="inputFirstName">Lien Adresse</label>
                                <input type="text" class="form-control" id="inputFirstName" placeholder="Lien Adresse" value="{{ $showroom->adresse_map }}" name="adresse_map">
                                @error('adresse_map')
                                <p style="color: red">{{ $message }}</p>
                                @enderror
                            </div>
