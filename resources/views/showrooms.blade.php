        ...
        <div class="templatemo-content-container">
            ...
            <div class="templatemo-content-container">
                <div class="templatemo-content-widget white-bg">
                    <h2 class="margin-bottom-10" align="center">Ajouter une showroom</h2>
                    <form action="{{ route('showrooms.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" id="inputFirstName" placeholder="Adresse" name="adresse">
                                @error('adresse')
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" id="inputFirstName" placeholder="Lien Adresse" name="adresse_map">
                                @error('adresse_map')
                                <p style="color: red">{{ $message }}</p>
                                @enderror
                            </div>
