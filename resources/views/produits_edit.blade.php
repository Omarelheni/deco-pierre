        ...
        <div class="templatemo-content-container">
            ...
            <div class="templatemo-content-container">
                <div class="templatemo-content-widget white-bg">
                    <h2 class="margin-bottom-10" align="center">Modifier un produit</h2>
                    <form action="{{ route('produits.update',$produit->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" id="inputFirstName" placeholder="nom" name="nom" value="{{  $produit->nom }}">
                                @error('nom')
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" id="inputFirstName" placeholder="prix" name ="prix" value="{{ $produit->prix }}">
                                @error('prix')
                                <p style="color: red">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" id="inputFirstName" placeholder="Quantite" name = "quantite" value="{{$produit->quantite}}">
                                @error('quantite')
                                <p style="color: red">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" id="inputFirstName" placeholder="description" name="description" value="{{$produit->description}}">
                                @error('description')
                                <p style="color: red">{{ $message }}</p>
                                @enderror
                            </div>
