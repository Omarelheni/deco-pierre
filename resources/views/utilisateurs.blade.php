        ...
        <div class="templatemo-content-container">
            ...
            <div class="templatemo-content-container">
                <div class="templatemo-content-widget white-bg">
                    <h2 class="margin-bottom-10" align="center">Ajouter un utilisateur</h2>
                    <form action="{{ route('utilisateurs.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                <label for="inputFirstName">Nom</label>
                                <input type="text" class="form-control" id="inputFirstName" placeholder="Nom" name="nom">
                                @error('nom')
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" id="inputFirstName" placeholder="Prenom" name ="prenom">
                                @error('prenom')
                                <p style="color: red">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" id="inputFirstName" placeholder="E-mail" name ="email">
                                @error('email')
                                <p style="color: red">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                <label for="inputFirstName">Mot de passe </label>
                                <input type="password" class="form-control" id="inputFirstName" placeholder="Mot de passe" name ="password">
                                @error('password')
                                <p style="color: red">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                <label for="inputFirstName">Mot de passe Confirme</label>
                                <input type="password" class="form-control" id="inputFirstName" placeholder="Mot de passe Confirme" name ="password_confirmation">
