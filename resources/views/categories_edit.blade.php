        ...
        <div class="templatemo-content-container">
            <div class="templatemo-content-widget no-padding">
                <div class="panel panel-default table-responsive">
                    ...
                    <table class="table table-striped table-bordered templatemo-user-table table-list-search">                        <thead>
                        ...
                        <tr>
                            <td>{{ $cat->nom }}</td>
                            <td><img src="{{ asset('images/'.$cat->image_name)}}" style="height: 100px;width: 100px;border-radius: 50px;"></td>
                            <td><a href="{{route('categories.edit',$cat->nom)}}" class="btn btn-info">Edit</a></td>
                            <td>
                                <form action="{{ route('categories.destroy', $cat->nom)}}" method="post">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="templatemo-content-container">
                <div class="templatemo-content-widget white-bg">
                    <h2 class="margin-bottom-10" align="center">Modifier une categorie</h2>
                    <form action="{{ route('categories.update',$categorie->nom) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row form-group">
                            <div class="col-lg-6 col-md-6 form-group">
                                <label for="inputFirstName">Nom</label>
                                <input type="text" class="form-control" id="inputFirstName" placeholder="nom" name="nom" value="{{  $categorie->nom }}">
                                @error('nom')
